...
public class PersonController {
	...
	public String searchPerson(@ModelAttribute("personModel") Person p, Model model) {

		model.addAttribute("personList", personService.getPersonsByFirstName(p.getFirstName()));
